...
import GraphViewV2 from '../../src/components/graph-view-v2';
...
describe('GraphViewV2 component', () => {
  let output = null;
  let nodes;
  let edges;
  let nodeTypes;
  ...
  describe('asyncRenderEdge method', () => {
    ...
    it('renders asynchronously', () => {
      ...
      expect(instance.syncRenderEdge).toHaveBeenCalledWith(edge, false, false);
    });
  ...
  describe('asyncRenderNode method', () => {
    ...
    it('renders asynchronously', () => {
      ...
      expect(requestAnimationFrame).toHaveBeenCalledTimes(1);
      expect(instance.syncRenderNode).toHaveBeenCalledWith(node, false, false);
    });
  });
